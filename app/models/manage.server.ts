...
export async function selectAllReserved(): Promise<object[]>{
    return await prisma.$queryRaw`SELECT Block.id AS blockId, Block.room_id AS roomId, Block.booked_user_id AS userId, User.username, Block.booked_time FROM Block, Room , User 
